...
const recentPosts = [
  ...
  },
  {
    ...
    excerpt: 'Dive deep into Tailwind CSS and learn how to create stunning designs with utility classes.',
    date: '2023-05-28',
  },
  {
    id: '3',
    title: 'The Power of React Server Components',
    excerpt: 'Explore the benefits of React Server Components and how they can improve your app performance.',
    date: '2023-05-25',
  },
]
          ...
          <div className="max-w-2xl mx-auto p-4">
            ...
            <ul className="border border-gray-200 rounded-lg overflow-hidden">
              {recentPosts.map((post, index) => (
                <li
                  key={post.id}
                  className={`p-4 ${index < recentPosts.length - 1 ? 'border-b border-gray-200' : ''
                    }`}
                >
                  <Link href={`/posts/${post.id}`} className="flex items-center space-x-4">
